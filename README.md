...
V0.4.5에서는 쥐의 이동을 일정한 좌우 왕복에서 살아있는 행동으로 바꿉니다.
쥐마다 다른 가속·보폭과 탐색 간격을 가지며, 경로 중간에 멈춰 킁킁거리고
치즈를 물면 몸을 낮춰 귀환합니다. 방향은 짧은 전환 동작을 거치고 꼬리는
몸보다 늦게 따라옵니다.
