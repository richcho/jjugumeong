...
- 구현 완료: 자동 왕복, 치즈 수집, 4종 업그레이드, 5개 지역 자동 해금,
  황금치즈, 클릭 부스트, 튜토리얼, 통계, Web 이중 저장, 오프라인 보상
- 다음 목표: 숫자 성장과 동시에 배경·쥐 장비·쥐구멍이 변화하는
  `V0.2 보이는 성장`

현재 버전은 기능을 검증하는 수직 슬라이스입니다. 지역별 고유 배경, 위험,
쥐 외형과 쥐구멍 진화는 다음 버전에서 구현합니다.
