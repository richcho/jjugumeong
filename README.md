...
- 현재 버전: `r4 0.2.7` (`V0.2 Alpha`)
- 주 테스트 환경: iPad Safari 및 홈 화면 PWA
- 구현 완료: 자동 왕복, 치즈 수집, 4종 업그레이드, 5개 지역, 황금치즈,
  클릭 부스트, 저장·오프라인 보상, 지역별 배경, 강화별 쥐 장비와 쥐구멍 성장
- 다음 목표: iPad Safari/PWA에서 V0.2 가로·세로 화면과 터치를 실기기로
  검증하고 발견 연출과 정보 밀도를 조정

실기기 결과는
[`docs/testing/ipad_v0.2_checklist.md`](docs/testing/ipad_v0.2_checklist.md)에
기기 정보, 절차와 판정을 기록합니다.

현재 버전은 보이는 성장까지 구현한 Alpha입니다. 선택형 지역 위험, 직업과
지역 재방문은 V0.2 실기기 완료 게이트를 통과한 뒤 V0.3에서 진행합니다.
